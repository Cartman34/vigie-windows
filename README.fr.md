...
présente le tout sous forme de cartes dans une fenêtre de navigateur. Sa fonction phare :
elle **maintient Windows Update verrouillé**, pour que Windows ne puisse jamais
redémarrer la machine tout seul — tout en vous laissant installer les mises à jour quand
*vous* l'avez décidé.
...
1. **Elle verrouille Windows Update.** Verrou posé, les mises à jour automatiques sont
