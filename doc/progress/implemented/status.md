...
| CORE-DEPLOY | Partiel | Carte Déploiement, `pwsh-install-machine`, `setup.cmd` | Éprouvé sur cette machine seulement. **La fenêtre d'annonce** ne s'adapte pas à une mise à jour, annonce un dossier avant qu'il soit choisi, répète les prérequis et mêle tutoiement et vouvoiement : relevé le 13/09 sur la capture de l'utilisateur, cible dans `targeting/install-update.md` |
