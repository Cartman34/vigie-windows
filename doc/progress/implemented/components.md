...
| Pièce | Création | Mise à jour, dépendance qui change | État cassé | Croissance | Maintenance | Désinstallation |
|---|---|---|---|---|---|---|
| clone du service | première synchronisation | **aucune réponse** : récupération sans forcer, bloquée par une étiquette déplacée le 13/09 | illisible : supprimé et recloné par `vigie-fetch.ps1` | sans objet | **aucune réponse** | retiré avec le profil |
