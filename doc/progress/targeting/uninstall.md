...
| 4bis | **Le droit « ouvrir une session en tant que tâche » du compte** | Stratégie de sécurité locale de l'ordinateur | Il nomme le compte par son identifiant : parti avec lui, il resterait dans la stratégie pour toujours. |
...
| 7ter | **L'identité sous laquelle Vigie notifie** | `HKLM\SOFTWARE\Classes\AppUserModelId\Sowapps.Vigie` | Écrite par l'installation pour qu'une bulle s'annonce « Vigie » et non « PowerShell ». Elle ne nomme que Vigie, et désigne une icône **dans le dossier d'installation** : laissée là, elle pointerait dans le vide. Une seule clé, pour toute la machine — c'est justement pourquoi elle n'est pas écrite dans le registre de chaque compte : le jour d'une désinstallation, la plupart de ces registres appartiennent à des gens qui ne sont pas connectés. |
| 7quater | **La source « Vigie » du journal d'événements** | Journal Application de Windows | Enregistrée au premier usage, elle resterait parmi les sources du journal après le départ de Vigie. |
