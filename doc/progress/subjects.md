...
| **S11** | Les bulles s'annoncent « PowerShell » | `apps/tray/tray.ps1` | `ShowBalloonTip` devient une notification Windows attribuée à l'application hôte : l'utilisateur voit *PowerShell*, pas *Vigie*. Signalé le 07/09. |
