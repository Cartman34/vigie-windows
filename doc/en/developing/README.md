...
- [`doc/fr/agent-working/briefing.md`](https://github.com/Cartman34/vigie-windows/blob/main/doc/fr/agent-working/briefing.md) — where the project stands, and the backlog
