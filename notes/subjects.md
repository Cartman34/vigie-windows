...
| **S14** | Les opérations ne suivent pas toutes le même protocole | `targeting/operations.md` · `implemented/operations.md` · **D122** | Constaté le 12/09 : une installation Windows Update annoncée terminée dès son départ, puis une carte figée sur « Démarrage… ». Quatre opérations longues lancent leur worker hors du protocole commun, et le protocole lui-même laisse trois fins silencieuses. Reste à trancher si les passes internes et les ordres de bureau rejoignent `/operations`, et comment la relance du serveur tient sa marque. Preuve : `notes/evidence/2026-09-12-operations-outside-the-protocol.md`. |
